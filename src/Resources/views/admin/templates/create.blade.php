    ...
    <div class="content">
        <div class="ms-5 me-5 mt-4">
            ...
            <nav class="mb-3">
                ...
                <span class="fw-400">Add New Template</span>
            </nav>

            <!-- Title -->
            <h2 class="title pt-2 text-uppercase">Add New Template</h2>
        </div>
                                ...
                                <select class="form-select" name="placeholders[]" id="placeholders" multiple>
                                    @foreach ($availablePlaceholders as $placeholder)
                                        <option value="{{ $placeholder->id }}"
                                            @if (in_array($placeholder->id, old('placeholders', []))) selected @endif>
                                            {{ $placeholder->name }}
                                        </option>
                                    @endforeach
                                </select>
